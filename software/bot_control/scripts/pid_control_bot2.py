...
class PID:
    def __init__(self):
        ...
        self.control_input_pub = rospy.Publisher('/bot2/cmd_vel', Twist, queue_size=10)
        self.current_state_sub=rospy.Subscriber('/bot2_pose', Pose2D,self.current_state_callback,queue_size=10)
        self.goal_pose_sub=rospy.Subscriber('/bot2_goal', Pose2D,self.goal_pose_callback,queue_size=10)
        self.goal_complete_flag=rospy.Publisher('/bot2waypoint_flag',Bool, queue_size=10)
...
if __name__ == '__main__':
    ...
    rospy.init_node('controller_node_bot2')
    rospy.loginfo("controller_node for bot2 created")
    pid_controller=PID()

...
class pose_publisher:
    ...
    def callback_opencv(self,data):
        ...
        if a[0].size==1:
            ...
            self.current_pose[0][2]=atan((bottomLeft[0]- bottomRight[0])/(bottomLeft[1]- bottomRight[1]))
        ...
        if a[0].size==1:
            ...
            self.current_pose[1][2]=atan((bottomLeft[0]- bottomRight[0])/(bottomLeft[1]- bottomRight[1]))
        a=np.where(ids==30)
        if a[0].size==1:
            (topLeft, topRight, bottomRight, bottomLeft) = corners[a[0][0]][0]
            topRight = (int(topRight[0]), int(topRight[1]))
            ...
            self.current_pose[2][2]=atan((bottomLeft[0]- bottomRight[0])/(bottomLeft[1]- bottomRight[1]))
        a=np.where(ids==40)
        if a[0].size==1:
            (topLeft, topRight, bottomRight, bottomLeft) = corners[a[0][0]][0]
            topRight = (int(topRight[0]), int(topRight[1]))
            ...
            self.current_pose[3][2]=atan((bottomLeft[0]- bottomRight[0])/(bottomLeft[1]- bottomRight[1]))
